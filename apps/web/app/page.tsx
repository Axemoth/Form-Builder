...
import { Sparkles, Layers, ShieldAlert, QrCode, Download, Shuffle, Rocket } from "lucide-react";
  ...
  const features = [
    {
      ...
      title: "9 Field Types",
      description:
        "From short text to star ratings — build any form you need. Text, numbers, emails, dropdowns, dates, and more, all beautifully styled.",
    },
    {
      icon: <Shuffle className="w-6 h-6" />,
      title: "Conditional Logic",
      description:
        "Smart field visibility. Configure fields that dynamically show or hide based on respondents' previous answers.",
    },
    {
      icon: <ShieldAlert className="w-6 h-6" />,
      title: "Password Protection",
      description:
        "Secure your forms. Set SHA-256 password protection to ensure only authorized users can access your surveys.",
    },
    {
      icon: <QrCode className="w-6 h-6" />,
      title: "QR Code Sharing",
      description:
        "Instant sharing. Generate QR codes to distribute your forms across channels — print, social, or in-person events.",
    },
    {
      icon: <Download className="w-6 h-6" />,
      title: "CSV Export",
      description:
        "Export all your responses in a clean CSV format with one click. Ready for analysis in any spreadsheet tool.",
    },
    {
      icon: <Sparkles className="w-6 h-6" />,
      title: "Dynamic Themes",
      description:
        "Choose from stunning visual themes for your published forms. Each theme is fully responsive and immersive.",
    },
  ];
